...
(function($) {
	...
	$.csv2table={
		...
		loadImg  : (new Image()).src='./opKintaiPlugin/img/icon-loadinfo.gif',  //Dafault loading IMG 
		sortNImg : (new Image()).src='./opKintaiPlugin/img/icon-n.gif',         //Dafault sort IMG N
		sortDImg : (new Image()).src='./opKintaiPlugin/img/icon-d-green.gif',   //Dafault sort IMG D 
		sortAImg : (new Image()).src='./opKintaiPlugin/img/icon-a-green.gif',   //Dafault sort IMG A
		setting  : [],
		data     : [],
		_rowsAry : [],
		_doc     : document,
